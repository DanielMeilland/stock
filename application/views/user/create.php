<div class="container">
    ...
    <div class="form-group <?= $error ? 'has-error' : '' ?>">
        ...
        <div class="input-group">
            ...
            <?= form_input('initials', set_value('initials'), ['class' => 'form-control']); ?>
        </div>
        <?= $error; ?>
    </div>
    ...
    <div class="form-group <?= $error ? 'has-error' : '' ?>">
        ...
        <div class="input-group">
            ...
            <?= form_input('phone', set_value('phone'), ['class' => 'form-control']); ?>
        </div>
        <?= $error; ?>
    </div>
    ...
    <div class="form-group <?= $error ? 'has-error' : '' ?>">
        <?= form_label('Lieu :', 'department_id', ['class' => 'control-label sr-only']); ?>
        <div class="input-group">
    ...
    <div class="form-group <?= $error ? 'has-error' : '' ?>">
        <?= form_label('Statut :', 'user_state_id', ['class' => 'control-label sr-only']); ?>
        <div class="input-group">
    ...
    <?php $error = form_error("email_confirm", "<p class='text-danger'>", '</p>'); ?>
    <div class="form-group <?= $error ? 'has-error' : '' ?>">
        <?= form_label('Confirmez votre adresse email :', 'email_confirm', ['class' => 'control-label sr-only']); ?>
        <div class="input-group">
            <div class="input-group-addon">Confirmez votre adresse email :</div>
            <?= form_input('email_confirm', set_value('email_confirm'), ['class' => 'form-control']); ?>
        </div>
        <?= $error; ?>
    </div>
