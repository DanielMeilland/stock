        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?= form_open_multipart('item/add/', ['classe' => 'form-horizontal']); ?>
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= form_input('stocking_place', set_value('stocking_place'), ['class' => 'form-control']); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= form_input('supplier', set_value('supplier'), ['class' => 'form-control']); ?>
                                </div>
                            </div>
