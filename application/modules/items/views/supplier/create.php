                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <?php $error = form_error("country", "<p class='text-danger'>", '</p>'); ?>
                            <div class="form-group <?= $error ? 'has-error' : '' ?>">
                                <?= form_label('Pays :', 'country', ['class' => 'control-label col-md-3']); ?>
                                <div class="input-group">
                                    <span class="input-group-addon"></span>
                                    <?= form_input('country', set_value('country'), ['class' => 'form-control col-md-8']); ?>
                                    <span class="input-group-addon"></span>
                                </div>
                                <?= $error; ?>
                            </div>
